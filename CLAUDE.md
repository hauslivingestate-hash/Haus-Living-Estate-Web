...
| 2 | **นัด Ben Poovaviranon หยุด apply migration** ช่วงสลับ | ⬜ รอ Ben |
| 3 | **บอกทีมหยุดบันทึกข้อมูล ~10 นาที** | ⬜ รอ Ben |
| 4 | **ตั้ง env ใน Vercel** 3 ตัวของโปรเจกต์ใหม่ + เช็ค `OPENAI_API_KEY` | ⬜ รอ Ben |
| 5 | **สลับจริง** (`full_cutover.ps1` → แก้โค้ด 6 จุด → push → Ben เช็ค production) | ⬜ รอ 2–4 |
