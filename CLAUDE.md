...
**เหลือในหน้าตั้งค่าที่ยังบันทึกไม่ได้จริง** (ทั้ง 3 ยังไม่มีตารางเก็บ — ต้องออกแบบ schema ก่อน): **เช็คลิสต์ทรัพย์ · เทมเพลตคำโฆษณา · เทมเพลต KPI** · ทั้ง 3 มีข้อความสีเหลืองบอกตรงๆ บนหน้าจอแล้ว
