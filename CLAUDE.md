...
- ⚠️ **id ลีดจะชนกันได้ในอนาคต**: ชีทออกเลขต่อที่ `L26-1224` · `create_lead` ในเว็บก็ออก max+1 = `L26-1224` เหมือนกัน → ถ้ามีคนเพิ่มลีดผ่านเว็บก่อน import รอบหน้า ลีดจากชีทกับจากเว็บจะได้ id เดียวกัน (สคริปต์เทียบด้วย id จะคิดว่าเป็นคนเดียวกันแล้วข้าม) · ต้องตกลงว่าใครเป็นคนออกเลข
